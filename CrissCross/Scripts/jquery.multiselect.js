...
$.widget("ech.multiselect", {
	...
	refresh: function( init ){
		...
		this.element.find('option').each(function( i ){
			...
			// changed by IDR 29/12/2011 - always checkbox, never radio
			html.push('<input id="'+inputID+'" name="multiselect_'+id+'" type="'+(o.multiple ? "checkbox" : "checkbox")+'" value="'+value+'" title="'+title+'"');
